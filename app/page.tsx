    ...
    <div className="min-h-screen bg-[#030712] text-white flex flex-col">
          ...
          <div className="flex h-16 items-center justify-between">
            <div className="flex items-center">
              <span className="text-xl font-bold tracking-tight">
                Prep<span className="text-blue-500">Bridge</span>
              </span>
            </div>
      ...
      <main className="flex-1 flex items-center justify-center relative overflow-hidden">
        <div className="container px-4 md:px-6 flex flex-col items-center text-center space-y-8 z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 min-w-[300px] sm:min-w-0">
            <Link href="/signup">
              <button className="group relative inline-flex h-12 items-center justify-center overflow-hidden rounded-md bg-blue-600 px-8 font-medium text-white transition-all duration-300 hover:bg-blue-700 hover:scale-105 hover:shadow-[0_0_20px_rgba(37,99,235,0.5)]">
      ...
      <footer className="border-t border-white/10 bg-[#111827]/50 py-8">
        <div className="container mx-auto px-4 text-center text-gray-500 text-sm">
          © 2024 PrepBridge. All rights reserved.
        </div>
      </footer>
    </div>
  );
